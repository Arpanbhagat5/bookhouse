RSpec.describe 'Reviews', type: :request do
  ...
  let!(:reviews) { create_list(:review, 5, book_id: book_id) }
  ...
  describe 'POST /books/id/reviews' do
    ...
    let(:valid_attributes) do
      { title: 'Good book', comment: 'I like it for its humor.', book_id: book_id }
    end
  ...
  describe 'PUT /reviews/:id' do
    let(:valid_attributes) {
      { id: review_id, title: 'Recommending to friends',
        comment: "Pretty amusing stuff", book_id: book_id, }
    }
